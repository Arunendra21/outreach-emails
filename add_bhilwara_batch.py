#!/usr/bin/env python3
"""Add verified Bhilwara company outreach contacts to city_bhilwara_01.csv.
...
serving Bhilwara are labelled with their HQ in the Notes column.
"""
import csv
import os
import re
...
OUTPUT_FILE = "city_bhilwara_01.csv"
HEADER = ["#", "Company", "Email", "Person", "Title", "City", "Notes"]

# (Company, Email, Person, Title, City, Notes)
ROWS = [
    ("Versatile IT Solution", "info@versatileitsolution.com", "Corporate Office", "General", "Bhilwara",
     "Bhilwara software/web dev; VERIFIED printed on versatileitsolution.com/contact-us; MX OK"),
    ("Versatile IT Solution", "hr@versatileitsolution.com", "HR Desk", "Recruitment", "Bhilwara",
     "Bhilwara software/web dev; VERIFIED printed on versatileitsolution.com/contact-us; MX OK"),
    ("Hukumsa", "hello@hukumsa.com", "Contact Desk", "General", "Bhilwara",
     "Bhilwara software/app dev; VERIFIED printed on hukumsa.com; MX OK"),
    ("Gen X Infotech", "info@genx-infotech.com", "Corporate Office", "General", "Bhilwara",
     "Bhilwara web design/dev services (HQ Amritsar); VERIFIED printed on genx-infotech.com; MX OK"),
]
